...
namespace Anberkada.MusicBase.Biz.Scales
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MajorPentatonicScale" /> class.
        /// </summary>
        /// <param name="baseTone">The base tone.</param>
        public MajorPentatonicScale(Tone baseTone)
            : base(baseTone)
        {
        ...
        /// </value>
        public override Scales Scale { get { return Scales.MajorPentatonic; } }
